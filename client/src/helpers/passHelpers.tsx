...
export const BodyInfo = [
  { id: 68, name: "Drop Kick", height: 0.2 },
  { id: 37, name: "Head", height: 0.55 },
  { id: 69, name: "Keeper Arm", height: 0.2 },
  { id: 38, name: "Left Foot", height: 0.05 },
  { id: 40, name: "Right Foot", height: 0.05 },
  { id: 70, name: "Other", height: 0.2 },
  { id: 106, name: "No Touch", height: 0.05 },
];
